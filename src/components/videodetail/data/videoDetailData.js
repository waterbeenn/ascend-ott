// src/components/videodetail/data/videoDetailData.js
...
export const sequenceData = [
    {
        ...
        desc: [
            ...
            "강도 : 상체를 세운 후 허벅지가 바닥과 평행해질 때까지 앉는 것을 목표로, 덤벨로 강도 높임 가능"
        ]
    },
    {
        id: 2,
        title: "싱글 레그 스쿼트 (Single Leg Squat)",
        timeCode: "05 : 28",
        duration: "02 : 30",
        count: "30회",
        ...
        desc: [
            ...
            "강도 : 초보자는 의자나 벤치에 한쪽 다리로 앉았다 일어나는 연습부터 시작, 점차 깊이 늘리기"
        ]
    },
    {
        id: 3,
        title: "사이드 스쿼트 (Side Squat)",
        timeCode: "15 : 41",
        duration: "01 : 30",
        count: "20회",
        ...
        desc: [
            ...
            "강도 : 앉을 때 엉덩이를 뒤로 빼고 상체를 숙이지 않도록 주의, 일어날 때 체중을 실은 다리의 힘으로."
        ]
    }
];
